...
public class MessageListener extends ListenerAdapter
{
    ...
    public MessageListener()
    {
        ...
        {
            //TODO add token
            JDA jda = JDABuilder.createDefault("token_here") // The token of the account that is logging in.
                    .addEventListeners(this)   // An instance of a class that will handle events.
                    .build();
