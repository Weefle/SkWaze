...
public class WazeEffectConstructorSchematic extends Effect {
    ...
    protected void execute(Event arg0) {
        ...
        try
        {
            bt.schematic = NMS.getInstance().getChooser().setSchematic(file, ((String)this.schematic.getSingle(arg0)).trim().replace("\"", ""));
        }
